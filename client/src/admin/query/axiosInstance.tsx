...
const API_URL = APP_SERVER_URL; // Replace with your API URL
...
const getToken = (): string | null => {
  return localStorage.getItem("atoken"); // Or fetch from memory store
};
...
const refreshToken = async () => {
  try {
    const response = await axiosInstance.get(
      "/api/admin/impression/" + localStorage.getItem("aid"),
      {
        headers: {
          "Content-Type": "application/json",
          sessionId: localStorage.getItem("atoken"),
